...
# library(haven)
# library(feather)
# casen <- read_dta("data/Casen_en_Pandemia_2020_STATA_revisada2022_09.dta")
# 
# casen <- casen %>%
#   mutate_at(vars(y2803c, ytro, y0101c, y0701c ), ~if_else(is.na(.), 0, .)) %>%
#   select(folio, y2803c, ytro, y0101c, y0701c, yautcorh, ytrabajocor, ymonecorh, yaimcorh, ytotcorh, yoprcor,
