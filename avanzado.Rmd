...
Queremos crear una columna que contenga es el mayor de estos valores a nivel de hogar. La idea es usar `rowwise`. 
...
mtcars2 <- mtcars %>% 
  mutate_at(vars(mpg, disp),  list(norm = do_silly_stuff) ) 
